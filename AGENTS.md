...
This project is distributed under the MIT License in `LICENSE.md`. Product-specific code, design, and bundled original shape assets are Copyright (c) 2026 Mikołaj Grabowski (Nick Sanchez). The included Toolcraft starter, runtime, UI component, documentation, and template source code are Copyright (c) 2026 Pixel Point. Preserve the notices in `LICENSE.md`, `NOTICE.md`, and `THIRD_PARTY_NOTICES.md` when redistributing the project.
